...
for ($i=1; $i < 12; $i++) {
  ...
  $urls[$i] = "http://wb/wb/load.php?type=".$i."&async=on&forcibly=on";
}
...
<div class="panel panel-default" style="margin: 0px 10px 10px 10px;">
    <div class="panel-heading" style="display: flex;"><h4 style="font-size: 13px;margin-top: 5px;">Продажи и заказы Wildberries</h4>
        ...
        <button class="btn btn-sm btn1 btn-color" id="forcibly" onclick="typeLoad();statusLoad();$('.loadForcibly').show();" style="border-radius: 4px; margin-right: 10px; margin-left: 10px; font-size: 12px; padding: 4px 6px; margin-top: px;">Обновить</button>
