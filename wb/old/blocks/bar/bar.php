...
function dates($bool,$data1,$data2,$cdt){
    ...
    if(!$bool and $dates['dataFinal']){
       // usort($dates['dataFinal'], "sort_date");
    }
   // $dates['dataFinal'] = array_values($dates['dataFinal']);

    // echo '<pre>'; var_dump($dates['column2']);

    return $dates;
}
// echo '<pre>'; var_dump($dates['column1']);
                ...
                foreach ($data2 as $item2) {
                    ...
                    if ($dat2 == $itemDate2) {
                      ...
                      if ($tot2 < 0) {
                       ...
                       // $series['sum']['dataTotal2'] += form_price($item2);
...
/*
//поиск сохраненных значений для сглаживания и валют
...
if(!$bool){
  ...
  //  echo '<pre>'; var_dump($dataArr['dataTotal2']);
...
//кнопка сглаживание
    // $('#smoothing').on('click', function() {
    function checkboxButton(){
        let cdt;
        let cdtSt;
        var series = $('#container').highcharts().series;
      //  var self = $('#container').highcharts().exportSVGElements[2];
    ...
    Highcharts.chart('container', {
        ...
        tooltip: {
          ...
          //  headerFormat: '<div class="tooltip-body">{point.key:%d.%m.%Y %A}<br>',
           ...
           // pointFormat: '<div class="line" style="background-color:{series.color}"></div>{series.name}: ' +'{point.y}<br>',
            //footerFormat: '{points[0].total}</div>',
            style: {
                font: "300 13px/19px 'Open Sans', 'Helvetica Neue', helvetica, arial, verdana, sans-serif",
            }
        },
        ...
        exporting: {
            buttons: {
              ...
              /*checkboxButtons: {
                    ...
                    theme: {
                      //  fill:"#efefef",
                        class: "button button1 highcharts-button highcharts-button-normal",
                    },
                ...
                totalButtons: {
                    ...
                    theme: {
                      stroke: "rgb(255,255,255)",
                        //fill:"#efefef",
                        class: "btn button button2 highcharts-button highcharts-button-normal",
                    },
                    onclick: totalButton,
                ...
                quanButtons: {
                    ...
                    theme: {
                      //  fill:"#efefef",
                        class: "button button3 highcharts-button highcharts-button-normal",
                    },
                    onclick: quanButton,
                },*/
            },
