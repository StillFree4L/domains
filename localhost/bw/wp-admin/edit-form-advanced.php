...
<div id="titlewrap">
    ...
    <div id="titleprior">
         ...
         * @param WP_Post $post Post object.
         */
        $prior_placeholder = apply_filters( 'enter_title_here', __( 'Add prior' ), $post );

        ?>
        <label class="screen-reader-text" id="prior-prompt-text" for="prior"><?php echo $prior_placeholder; ?></label>
        <input type="number" name="post_prior" size="30" value="<?php echo esc_attr( $post->post_prior ); ?>" id="prior" spellcheck="true" autocomplete="off" />
    </div>
	<?php
	/**
