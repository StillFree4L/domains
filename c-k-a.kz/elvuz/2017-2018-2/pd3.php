...
$result5 = mysql_query ("select * from journal175 where StudentID=$myrow[StudentID] and StudyGroupID=$ved and markTypeID=7 and isCurrent=1");
...
$r3=$myrow5['Mark'];
$rd = round(($sotu1+$r1+$sotu2+$r2+$r3)/5);
...
//<td>$sotu1</td><td>$r1</td><td>$sotu2</td><td>$r2</td><td>$r3</td>
