...
if (isset($_REQUEST['add']))
{
	...
	if (isset($_REQUEST['ved'])) 
	{
		...
		$result = mysql_query ("INSERT INTO  `nitro`.`dopved` (`id` ,`groupID` ,`ved` ,`opis` ,`type`,`god` ,`sem`) VALUES (NULL ,  '$groups',  '$ved',  '1',  '$t','2017','2');");
...
{
echo "<table border=1>";
$result = mysql_query ("select * from dopved where god=2017 and sem=2");
$myrow = mysql_fetch_array($result);
do
{
$result1 = mysql_query ("select * from groups2017 where groupID=$myrow[groupID]");
...
do
{
$result4 = mysql_query ("select * from students2017 where StudentID=$myrow3[studentID]");
...
$result4 = mysql_query("select * from groups2017 where groupID=$myrow[groupID]");
$myrow4 = mysql_fetch_array($result4);
...
{
$i++;
$result2 = mysql_query ("select * from students2017 where StudentID=$myrow1[studentID]");
$myrow2 = mysql_fetch_array($result2);
