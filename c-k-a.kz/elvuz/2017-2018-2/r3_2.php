...
$result10 = mysql_query ("select * from disved  where kur=1 and god=2017 and sem=2");
	...
	do
		{
			...
			$myrow11 = mysql_fetch_array($result11);
			  ...
			  echo "<tr><td> $myrow11[name]</td><td>$myrow10[dis]</td><td><a href=p33.php?ved=$myrow10[ved]&groupID=$myrow10[groupID]>kur1</a></td><td><a href=p3.php?ved=$myrow10[ved]&groupID=$myrow10[groupID]>kur</a></td><td><a href=pd3.php?ved=$myrow10[ved]&groupID=$myrow10[groupID]>RD</a></td><td><a href=ex3.php?ved=$myrow10[ved]&groupID=$myrow10[groupID]&testID=$myrow10[testID]&t=3>Exam</a></td> </tr> ";
		}
