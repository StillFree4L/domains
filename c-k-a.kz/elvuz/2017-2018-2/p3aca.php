...
if ($myrow1['kur']<0) {$mark="Неявка по ув.п.";				$bukva= ""; 		$ball = "";}
if (($myrow1['kur'] =='') or  ($myrow1['kur'] ==0))		{$mark="";				$bukva= ""; 		$ball = "";}
if (($myrow1['kur'] >=1) and  ($myrow1['kur'] <=49))   	{$mark=$myrow1['kur'];	$bukva= "F"; 		$ball = "0";}
if (($myrow1['kur'] >=50) and  ($myrow1['kur'] <=54)) 	{$mark=$myrow1['kur'];	$bukva= "D"; 		$ball = "1.0";}
if (($myrow1['kur'] >=55) and  ($myrow1['kur'] <=59)) 	{$mark=$myrow1['kur'];	$bukva= "D+"; 	$ball = "1.33";}
if (($myrow1['kur'] >=60) and  ($myrow1['kur'] <=64)) 	{$mark=$myrow1['kur'];	$bukva= "C-";	$ball = "1.67";}
if (($myrow1['kur'] >=65) and  ($myrow1['kur'] <=69)) 	{$mark=$myrow1['kur'];	$bukva= "C"; 		$ball = "2.0";}
if (($myrow1['kur'] >=70) and  ($myrow1['kur'] <=74)) 	{$mark=$myrow1['kur'];	$bukva= "C+"; 	$ball = "2.33";}
if (($myrow1['kur'] >=75) and  ($myrow1['kur'] <=79)) 	{$mark=$myrow1['kur'];	$bukva= "B-";	$ball = "2.67";}
if (($myrow1['kur'] >=80) and  ($myrow1['kur'] <=84)) 	{$mark=$myrow1['kur'];	$bukva= "B"; 		$ball = "3.0";}
if (($myrow1['kur'] >=85) and  ($myrow1['kur'] <=89)) 	{$mark=$myrow1['kur'];	$bukva= "B+"; 	$ball = "3.33";}
if (($myrow1['kur'] >=90) and  ($myrow1['kur'] <=94)) 	{$mark=$myrow1['kur'];	$bukva= "A-";	$ball = "3.67";}
if (($myrow1['kur'] >=95) and  ($myrow1['kur'] <=100)) 	{$mark=$myrow1['kur'];	$bukva= "A"; 		$ball = "4.0";}
