...
echo "<input type=submit value='Сохранить изменения'></td></table></form>";
	...
	$result3 = mysql_query ("select * from journal173 where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=6 and number=2");
	$myrow3 = mysql_fetch_array($result3);

	$result4 = mysql_query ("select * from journal173 where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=2 and number=2");
...
if ($myrow3['Mark']=='') 
	{ $result5= mysql_query("INSERT INTO `nitro`.`journal173` (`StudentID`, `Mark`, `MarkDate`, `StudyGroupID`, `markTypeID`, `number`) VALUES ('$StudentID', '$sotu2', '2017-04-20', '$ved', '6', '2');");	}
else { $result = mysql_query("update journal173 set Mark='$sotu2'  where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=6 and number=2"); }

if ($myrow4['Mark']=='') 
	{ $result5= mysql_query("INSERT INTO `nitro`.`journal173` (`StudentID`, `Mark`, `MarkDate`, `StudyGroupID`, `markTypeID`, `number`) VALUES ('$StudentID', '$r2', '2017-04-20', '$ved', '2', '2');");	}
else 
{ $result = mysql_query("update journal173 set Mark='$r2'  where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=2 and number=2"); }
...
$i=1;
	do
		...
		if  ($kurs==1){
			...
			$result3 = mysql_query ("select * from journal173 where StudyGroupID=$ved and StudentID=$myrow[StudentID] and markTypeID=6 and number=2");
			$myrow3 = mysql_fetch_array($result3);

			$result4 = mysql_query ("select * from journal173 where StudyGroupID=$ved and StudentID=$myrow[StudentID] and markTypeID=2 and number=2");
			$myrow4 = mysql_fetch_array($result4);
