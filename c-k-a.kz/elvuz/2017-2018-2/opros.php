...
<?
$result = mysql_query("select * from nitro.anketa_work where teacherID=1 and order by teacherid, voprosid");
$myrow = mysql_fetch_array($result);

do
{
echo "$myrow[id] | $myrow[teacherID] | $myrow[kurs] | $myrow[studentID] | $myrow[lang] | $myrow[groupID] | $myrow[voprosID] | $myrow[ball]<br>";
$s1 = $s1+$myrow['ball'];
}
