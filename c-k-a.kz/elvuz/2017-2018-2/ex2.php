...
//satu2
//	$result3 = mysql_query ("select * from journal174 where StudentID=$myrow[StudentID] and StudyGroupID=$ved and markTypeID=6 and number=2");
//	$myrow3 = mysql_fetch_array($result3);
///r2
//	$result4 = mysql_query ("select * from journal174 where StudentID=$myrow[StudentID] and StudyGroupID=$ved and markTypeID=2 and number=2");
...
if ($t==1) 
{
$result6 = mysql_query ("select * from disved where ved=$ved and god=2017");
