...
echo "<tr><td align=right class=border-ram>$i.</td><td class=border-ram>$myrow1[student] </td><td align=center class=border-ram>$myrow1[zachetka]</td><td align=center class=border-ram>$mark</td><td align=center class=border-ram>$bukva</td><td align=center class=border-ram1>$ball</td></tr>";
//$i++;
//}
