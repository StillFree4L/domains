...
//echo "$t[3] - $a[3] $myrow21[Mark] - $myrow22[Mark] - $myrow23[Mark] - $myrow24[Mark]  - $myrow5[ball] = $totalmark3<br>";
}
if ($t[3]==2) 
{
...
//echo "$t[4] - $a[4] $myrow31[Mark] - $myrow32[Mark] - $myrow33[Mark] - $myrow34[Mark]  - $myrow5[ball] = $totalmark4<br>";
}
if ($t[4]==2) 
{
...
printf("<tr><td>$x.</td><td>%s %s %s</td><td align=center> %s</td><td align=center> %s</td><td>$bukva1</td><td>$ball1</td><td align=center> %s</td><td>$bukva2</td><td>$ball2</td><td align=center> %s</td><td>$bukva3</td><td>$ball3</td><td align=center> %s</td><td>$bukva4</td><td>$ball4</td><td align=center> %s</td><td>$bukva5</td><td>$ball5</td><td align=center> %s</td><td>$bukva6</td><td>$ball6</td><td align=center> %s</td><td>$bukva7</td><td>$ball7</td><td align=center> %s</td><td>$bukva8</td><td>$ball8</td><td align=center> %s</td><td>$bukva9</td><td>$ball9</td><td align=center> %s</td><td>$bukva10</td><td>$ball10</td><td align=center> %s</td><td>$bukva11</td><td>$ball11</td><td>$gpa</td></tr>",$myrow['lastname'],$myrow['firstname'],$myrow['patronymic'],$myrow['zachetka'],$totalmark1,$totalmark2,$totalmark3,$totalmark4,$totalmark5,$totalmark6,$totalmark7,$totalmark8,$totalmark9,$totalmark10,$totalmark11);
