...
echo "<tr><td>$myrow[lastname] $myrow[firstname] $myrow[patronymic] </td><td align=center>$myrow1[Mark]</td><td align=center>$myrow2[Mark]</td><td align=center>$myrow3[Mark]</td><td align=center>$myrow4[Mark]</td><td align=center>$myrow5[ratings]</td><td align=center>$myrow5[exammark]</td><td align=center>$myrow5[totalmark]</td></tr>";
//Mark
//markTypeID
//number
}
...
do
{
  echo "<a href=ved.php?ved=$myrow[ved]&groups=$groups&sem=$sem>$myrow[dis]</a><br>";
}
while ($myrow = mysql_fetch_array($result));
} else {
...
?>
  ...
  <form action="ved.php" method="get" name="group">
...
<input type=hidden value=<? echo $sem?> name=sem>


<input type="submit" value="ОK"></p>
  </form>
<? } }?>
