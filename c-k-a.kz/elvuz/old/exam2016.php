...
echo "<p>";
	do
		{
			  echo "<a href=exam2016.php?groups=$myrow[groupID]&sem=2&kurs=$myrow[kurs]>$myrow[name]</a> | ";
		}
...
if (isset($_REQUEST['groups'])) 
	{
		...
		$myrow = mysql_fetch_array($result);
			do
				{
					  echo "<p><a href=ex2016.php?ved=$myrow[ved]&groups=$groups&sem=$sem&t=$myrow[type]&kurs=$kurs>$myrow[dis]</a></p>";
				}
			while ($myrow = mysql_fetch_array($result));
	}
