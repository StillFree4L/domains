...
echo "<input type=submit value='Сохранить изменения'></td></table></form>";
	...
	$result1 = mysql_query ("select * from journal2017 where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=6 and number=1");
	$myrow1 = mysql_fetch_array($result1);

	$result2 = mysql_query ("select * from journal2017 where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=2 and number=1");
	$myrow2 = mysql_fetch_array($result2);
	$result3 = mysql_query ("select * from journal2017 where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=6 and number=2");
	$myrow3 = mysql_fetch_array($result3);

	$result4 = mysql_query ("select * from journal2017 where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=2 and number=2");
	$myrow4 = mysql_fetch_array($result4);

if ($myrow1['Mark']=='') 
	{  $result5= mysql_query("INSERT INTO `nitro`.`journal2017` (`StudentID`, `Mark`, `MarkDate`, `StudyGroupID`, `markTypeID`, `number`) VALUES ('$StudentID', '$sotu1', '2017-04-20', '$ved', '6', '1');");	}
else 
	{ $result = mysql_query("update journal2017 set Mark='$sotu1'  where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=6 and number=1"); 	}

if ($myrow2['Mark']=='') 
	{ $result5= mysql_query("INSERT INTO `nitro`.`journal2017` (`StudentID`, `Mark`, `MarkDate`, `StudyGroupID`, `markTypeID`, `number`) VALUES ('$StudentID', '$r1', '2017-04-20', '$ved', '2', '1');");	}
else { $result = mysql_query("update journal2017 set Mark='$r1'  where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=2 and number=1"); }

if ($myrow3['Mark']=='') 
	{ $result5= mysql_query("INSERT INTO `nitro`.`journal2017` (`StudentID`, `Mark`, `MarkDate`, `StudyGroupID`, `markTypeID`, `number`) VALUES ('$StudentID', '$sotu2', '2017-04-20', '$ved', '6', '2');");	}
else { $result = mysql_query("update journal2017 set Mark='$sotu2'  where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=6 and number=2"); }

if ($myrow4['Mark']=='') 
	{ $result5= mysql_query("INSERT INTO `nitro`.`journal2017` (`StudentID`, `Mark`, `MarkDate`, `StudyGroupID`, `markTypeID`, `number`) VALUES ('$StudentID', '$r2', '2017-04-20', '$ved', '2', '2');");	}
else 
{ $result = mysql_query("update journal2017 set Mark='$r2'  where StudentID='$StudentID' and StudyGroupID='$ved' and markTypeID=2 and number=2"); }
...
if (isset($_REQUEST['ved']))
{
	...
	$myrow = mysql_fetch_array($result);
echo "<br><br><form action=con2017.php method=get name=ins><table><tr><td align=center ><b>Код слушателя</td><td align=center><b>ФИО слушателя</td><td align=center><b>Зачетка</td><td align=center><b>Соту 1</td><td align=center><b>Р1</td><td align=center><b>Соту 2</td><td align=center><b>Р2</td><td align=center><b>Рейтинг допуска</td></tr>";
$i=1;
	do
		{
		...
		if  ($kurs==1){
			$result1 = mysql_query ("select * from journal2017 where StudyGroupID=$ved and StudentID=$myrow[StudentID] and markTypeID=6 and number=1");
			$myrow1 = mysql_fetch_array($result1);

			$result2 = mysql_query ("select * from journal2017 where StudyGroupID=$ved and StudentID=$myrow[StudentID] and markTypeID=2 and number=1");
			$myrow2 = mysql_fetch_array($result2);
			
			$result3 = mysql_query ("select * from journal2017 where StudyGroupID=$ved and StudentID=$myrow[StudentID] and markTypeID=6 and number=2");
			$myrow3 = mysql_fetch_array($result3);

			$result4 = mysql_query ("select * from journal2017 where StudyGroupID=$ved and StudentID=$myrow[StudentID] and markTypeID=2 and number=2");
			$myrow4 = mysql_fetch_array($result4);
