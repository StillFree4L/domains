...
if ($myrow1['r2']<0) {$mark="Неявка по ув.п.";				$bukva= ""; 		$ball = "";}
if (($myrow1['r2'] =='') or  ($myrow1['r2'] ==0))		{$mark="";				$bukva= ""; 		$ball = "";}
if (($myrow1['r2'] >=1) and  ($myrow1['r2'] <=49))   	{$mark=$myrow1['r2'];	$bukva= "F"; 		$ball = "0";}
if (($myrow1['r2'] >=50) and  ($myrow1['r2'] <=54)) 	{$mark=$myrow1['r2'];	$bukva= "D"; 		$ball = "1.0";}
if (($myrow1['r2'] >=55) and  ($myrow1['r2'] <=59)) 	{$mark=$myrow1['r2'];	$bukva= "D+"; 	$ball = "1.33";}
if (($myrow1['r2'] >=60) and  ($myrow1['r2'] <=64)) 	{$mark=$myrow1['r2'];	$bukva= "C-";	$ball = "1.67";}
if (($myrow1['r2'] >=65) and  ($myrow1['r2'] <=69)) 	{$mark=$myrow1['r2'];	$bukva= "C"; 		$ball = "2.0";}
if (($myrow1['r2'] >=70) and  ($myrow1['r2'] <=74)) 	{$mark=$myrow1['r2'];	$bukva= "C+"; 	$ball = "2.33";}
if (($myrow1['r2'] >=75) and  ($myrow1['r2'] <=79)) 	{$mark=$myrow1['r2'];	$bukva= "B-";	$ball = "2.67";}
if (($myrow1['r2'] >=80) and  ($myrow1['r2'] <=84)) 	{$mark=$myrow1['r2'];	$bukva= "B"; 		$ball = "3.0";}
if (($myrow1['r2'] >=85) and  ($myrow1['r2'] <=89)) 	{$mark=$myrow1['r2'];	$bukva= "B+"; 	$ball = "3.33";}
if (($myrow1['r2'] >=90) and  ($myrow1['r2'] <=94)) 	{$mark=$myrow1['r2'];	$bukva= "A-";	$ball = "3.67";}
if (($myrow1['r2'] >=95) and  ($myrow1['r2'] <=100)) 	{$mark=$myrow1['r2'];	$bukva= "A"; 		$ball = "4.0";}
