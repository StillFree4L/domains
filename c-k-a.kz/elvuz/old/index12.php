...
echo "<table border=1><tr><td>fio</td><td>CATY1</td><td>P1</td><td>CATY2</td><td>P2</td><td>RD</td><td>Exam</td><td>Itog</td></tr>";
do
{ 
//satu1
...
echo "<tr><td>$myrow[lastname] $myrow[firstname] $myrow[patronymic] </td><td>$myrow1[Mark]</td><td>$myrow2[Mark]</td><td>$myrow3[Mark]</td><td>$myrow4[Mark]</td></tr>";
//Mark
//markTypeID
//number
}
...
do
{
  echo "<a href=ved.php?ved=$myrow[ved]&groups=$groups>$myrow[dis]</a><br>";
}
while ($myrow = mysql_fetch_array($result));
