...
echo "<tr><td class=le-content><a href=view_test.php?kurs=$myrow[kurs]&testID=$myrow[testID]&type=$myrow[type]&groupID=$groups>$myrow[dis]</td><td class=le-content>$myrow[lang]</td><td class=le-content>$myrow[kurs]</td><td class=le-content>$myrow[semestr]</td>";
...
echo "<tr><td>$i - <input name=StudentID$i type=hidden value=$myrow1[StudentID]> - $myrow1[lastname] $myrow1[firstname]  $myrow1[patronymic]</td><td><input name=bal$i type=text value=$myrow2[ball]></td><td align=center>";

echo "<a href=view_test.php?kurs=$kurs&testID=$testID&type=$type&groupID=$groupID&id=$myrow2[id]&groupID=$groupID><img src=images/remove.png width=30></a></td></tr>";
