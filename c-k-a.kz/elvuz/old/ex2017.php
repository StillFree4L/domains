...
<body text=2>
<?
$podgroupID=$_REQUEST['podgroupID']; 
//$ved=$_REQUEST['ved']; 
$t=2; 
		$kurs=$_REQUEST['kurs']; 
...
?>
Cовременная история Казахстана
</p>
</td></tr></table>
...
$result = mysql_query ("select * from govex where podgroupID=$podgroupID");
$myrow = mysql_fetch_array($result);
do
{ 
$ved = $myrow['disID'];
...
echo "<td align=right class=border-ram>$i.</td><td class=border-ram>$myrow11[lastname] $myrow11[firstname] $myrow11[patronymic] </td>";
echo "<td align=center class=border-ram>$myrow11[zachetka]</td>";
