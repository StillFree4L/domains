...
<?
$result = mysql_query ("select * from test_work where data > '29-05-2017 00:00:00' order by groupID");
...
$result4 = mysql_query ("select * from groups where groupID=$myrow[groupID]");
$myrow4 = mysql_fetch_array($result4);

if ($myrow['ball']==-1) 
{			  
	echo "<tr><td>$i</td><td>$myrow4[name]</td><td>$myrow2[lastname] $myrow2[firstname] $myrow2[patronymic]</td><td>$myrow3[dis]</td><td>Не явка</td></tr>";
}
else 
{			  
	echo "<tr><td>$i</td><td>$myrow4[name]</td><td>$myrow2[lastname] $myrow2[firstname] $myrow2[patronymic]</td><td>$myrow3[dis]</td><td>$myrow[ball]</td></tr>";
}
