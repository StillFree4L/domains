...
$groupID = $_REQUEST['groupID'];
		...
		do
		{
			...
			$t[$i]=$myrow20['type'];
//echo "$i - $t[$i] - $a[$i]<br>";
			echo "<td align=center colspan=3><b>$myrow20[dis] <br>$myrow20[type]</td>";
		}
...
if ($t[1]==3) 
{
	...
	$result1_5 = mysql_query ("select * from oral_exam where studentID=$myrow[StudentID] and testID=$myrow6[id] and god=2017");
	$myrow1_5 = mysql_fetch_array($result1_5);

	$result1_7 = mysql_query ("select * from test_work where studentID=$myrow[StudentID] and testID=$myrow6[testID] and god=2017");
	$myrow1_7 = mysql_fetch_array($result1_7);

$d=($myrow1_5['ball']+$myrow1_7['ball'])/2;
$s=($myrow1['Mark']+$myrow2['Mark']+$myrow3['Mark']+$myrow4['Mark'])/4;
$c=(($myrow1_5['ball']+$myrow1_7['ball'])/2)*0.4;
$s1=$s*0.6;
if ($d>=50) {	$totalmark1 = round(($s)*0.6+($d*0.4));} else {
$totalmark1=0;
//$totalmark1 = round((($myrow1['Mark']+$myrow2['Mark']+$myrow3['Mark']+$myrow4['Mark'])/4)*0.6+$d*0.4);
}
}
...
$d=($myrow5['ball']+$myrow7['ball'])/2;
$s=($myrow11['Mark']+$myrow12['Mark']+$myrow13['Mark']+$myrow14['Mark'])/4;
$c=(($myrow5['ball']+$myrow7['ball'])/2)*0.4;
$s1=$s*0.6;
if ($d>=50) {	$totalmark2 = round(($s)*0.6+($d*0.4));} else {
$totalmark2=0;
//$totalmark1 = round((($myrow1['Mark']+$myrow2['Mark']+$myrow3['Mark']+$myrow4['Mark'])/4)*0.6+$d*0.4);
}
...
$d=($myrow5['ball']+$myrow7['ball'])/2;
$s=($myrow31['Mark']+$myrow32['Mark']+$myrow33['Mark']+$myrow34['Mark'])/4;
$c=(($myrow5['ball']+$myrow7['ball'])/2)*0.4;
$s1=$s*0.6;
if ($d>=50) {	$totalmark4 = round(($s)*0.6+($d*0.4));} else {
$totalmark4=0;
//$totalmark1 = round((($myrow1['Mark']+$myrow2['Mark']+$myrow3['Mark']+$myrow4['Mark'])/4)*0.6+$d*0.4);
}
...
$d=($myrow5['ball']+$myrow7['ball'])/2;
$s=($myrow41['Mark']+$myrow42['Mark']+$myrow43['Mark']+$myrow44['Mark'])/4;
$c=(($myrow5['ball']+$myrow7['ball'])/2)*0.4;
$s1=$s*0.6;
if ($d>=50) {	$totalmark5 = round(($s)*0.6+($d*0.4));} else {
$totalmark5=0;
//$totalmark1 = round((($myrow1['Mark']+$myrow2['Mark']+$myrow3['Mark']+$myrow4['Mark'])/4)*0.6+$d*0.4);
}
...
$d=($myrow5['ball']+$myrow7['ball'])/2;
$s=($myrow111['Mark']+$myrow112['Mark']+$myrow113['Mark']+$myrow114['Mark'])/4;
$c=(($myrow5['ball']+$myrow7['ball'])/2)*0.4;
$s1=$s*0.6;
if ($d>=50) {	$totalmark12 = round(($s)*0.6+($d*0.4));} else {
$totalmark12=0;
//$totalmark1 = round((($myrow1['Mark']+$myrow2['Mark']+$myrow3['Mark']+$myrow4['Mark'])/4)*0.6+$d*0.4);
}
