...
$i=0;			
$credit=0;
echo "<table border=0 align=center><tr><td></td><td></td><td width=300><b><p align=center>Бекітемін</p><p>  Заң институт бастығының орынбасары,<br>  әрі күндізгі оқыту факультетінің бастығы<br>  полиция полковнигі</p><p> _________________________ Т.З.Аймағанбетов </p></td></tr><tr><td colspan=2 align=center><b>ҚОРЫТЫНДЫ ЖИЫНТЫҚ ВЕДОМОСІ<br>СВОДНАЯ ИТОГОВАЯ ВЕДОМОСТЬ</b></td></tr><tr><td>Күндізгі оқыту факультеті/Факультет очного обучения ____ семестр 2016-2017 оқу жылы/уч.год<br>Мамандық: «5В030300–Құқық қорғау қызметі»<br>Специальность: «5В030300-Правоохранительная деятельность» $myrow[name] оқу тобы/учебная группа</td><td></td></tr></table><table border=1>";
//
...
printf("<tr><td>$w.</td><td>%s %s %s</td><td align=center> %s</td><td align=center> %s</td><td>$bukva1</td><td>$ball1</td><td align=center> %s</td><td>$bukva2</td><td>$ball2</td><td align=center> %s</td><td>$bukva3</td><td>$ball3</td><td align=center> %s</td><td>$bukva4</td><td>$ball4</td><td align=center> %s</td><td>$bukva5</td><td>$ball5</td><td align=center> %s</td><td>$bukva6</td><td>$ball6</td><td align=center> %s</td><td>$bukva7</td><td>$ball7</td><td align=center> %s</td><td>$bukva8</td><td>$ball8</td><td align=center> %s</td><td>$bukva9</td><td>$ball9</td><td>$gpa</td></tr>",$myrow1['lastname'],$myrow1['firstname'],$myrow1['patronymic'],$myrow1['zachetka'],$myrow101['totalmark'],$myrow102['totalmark'],$myrow103['totalmark'],$myrow104['totalmark'],$myrow105['totalmark'],$myrow106['totalmark'],$myrow107['totalmark'],$myrow108['totalmark'],$myrow109['totalmark']);
}
...
echo "</table>";
echo "<table width=100%><tr><td><p><b>Мониторинг және білім сапасын бағалау <br>бөлімінің бастығы	<br>полиция полковнигі</p></td><td align=right><b>Б.К.Жилкибаев</b></td></tr></table>";
		}
...
$gpa=round($dd/$credit,2);
$sum =round(($myrow101['totalmark'] + $myrow102['totalmark'] + $myrow103['totalmark'] + $myrow104['totalmark'] + $myrow105['totalmark'] + $myrow106['totalmark'] + $myrow107['totalmark'] + $myrow108['totalmark'] + $myrow109['totalmark'] + $myrow110['totalmark'] + $myrow111['totalmark'])/11);
printf("<tr><td>$w</td><td>%s %s %s</td><td>$myrow1[zachetka]</td><td align=center> %s</td><td>$bukva1</td><td>$ball1</td><td align=center> %s</td><td>$bukva2</td><td>$ball2</td><td align=center> %s</td><td>$bukva3</td><td>$ball3</td><td align=center> %s</td><td>$bukva4</td><td>$ball4</td><td align=center> %s</td><td>$bukva5</td><td>$ball5</td><td align=center> %s</td><td>$bukva6</td><td>$ball6</td><td align=center> %s</td><td>$bukva7</td><td>$ball7</td><td align=center> %s</td><td>$bukva8</td><td>$ball8</td><td align=center> %s</td><td>$bukva9</td><td>$ball9</td><td align=center> %s</td><td>$bukva10</td><td>$ball10</td><td  align=center> %s</td><td>$bukva11</td><td>$ball11</td><td>$gpa</td></tr>",$myrow1['lastname'],$myrow1['firstname'],$myrow1['patronymic'],$myrow101['totalmark'],$myrow102['totalmark'],$myrow103['totalmark'],$myrow104['totalmark'],$myrow105['totalmark'],$myrow106['totalmark'],$myrow107['totalmark'],$myrow108['totalmark'],$myrow109['totalmark'],$myrow110['totalmark'],$myrow111['totalmark']);
}
while ($myrow1 = mysql_fetch_array($result1));
...
printf("<tr><td>$w.</td><td>%s %s %s</td><td>$myrow1[zachetka]</td><td align=center> %s</td><td>$bukva1</td><td>$ball1</td><td align=center> %s</td><td>$bukva2</td><td>$ball2</td><td align=center> %s</td><td>$bukva3</td><td>$ball3</td><td align=center> %s</td><td>$bukva4</td><td>$ball4</td><td align=center> %s</td><td>$bukva5</td><td>$ball5</td><td align=center> %s</td><td>$bukva6</td><td>$ball6</td><td align=center> %s</td><td>$bukva7</td><td>$ball7</td><td align=center> %s</td><td>$bukva8</td><td>$ball8</td><td align=center> %s</td><td>$bukva9</td><td>$ball9</td><td align=center> %s</td><td>$bukva10</td><td>$ball10</td><td  align=center> %s</td><td>$bukva11</td><td>$ball11</td><td >%s</td><td>$bukva12</td><td>$ball12</td><td >%s</td><td>$bukva13</td><td>$ball13</td><td>$gpa</td></tr>", $myrow1['lastname'],$myrow1['firstname'],$myrow1['patronymic'],$myrow101['totalmark'],$myrow102['totalmark'],$myrow103['totalmark'],$myrow104['totalmark'],$myrow105['totalmark'],$myrow106['totalmark'],$myrow107['totalmark'],$myrow108['totalmark'],$myrow109['totalmark'],$myrow110['totalmark'],$myrow111['totalmark'],$myrow112['totalmark'],$myrow113['totalmark']);
}
while ($myrow1 = mysql_fetch_array($result1));
