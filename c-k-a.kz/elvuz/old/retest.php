...
echo "<p>";
	do
		{
			  echo "<a href=retest.php?groups=$myrow[groupID]&kurs=$myrow[kurs]&lang=$myrow[lang]>$myrow[name]</a> | ";
		}
...
echo "<tr><td class=le-content><a href=retest.php?kurs=$myrow[kurs]&testID=$myrow[id]&type=$myrow[type]&groupID=$groups>$myrow[namedis]</td><td class=le-content>$myrow[lang]</td><td class=le-content>$myrow[kurs]</td><td class=le-content>$myrow[semestr]</td>";
...
$i=0;
echo "<form action=retest.php method=get name=ins><table border=0><tr><td align=center><b>Ф.И.О.</b></td><td align=center><b>Тестирование</b></td><td align=center><b>Удалить результат</b></td></tr>";
...
echo "<tr><td>$i - <input name=StudentID$i type=hidden value=$myrow1[StudentID]> - $myrow1[lastname] $myrow1[firstname]  $myrow1[patronymic]</td><td><input name=bal$i type=text value=$myrow2[ball]></td><td align=center><a href=retest.php?kurs=$kurs&testID=$testID&type=$type&groupID=$groupID&id=$myrow2[id]&groupID=$groupID><img src=images/remove.png width=30></a></td></tr>";

//echo "<tr><td>$i. $myrow1[lastname] $myrow1[firstname]  $myrow1[patronymic]</td><td>$myrow2[ball]</td><td align=center><a href=retest.php?kurs=$kurs&testID=$testID&type=$type&groupID=$groupID&id=$myrow2[id]&groupID=$groupID><img src=images/remove.png width=30></a></td></tr>";
