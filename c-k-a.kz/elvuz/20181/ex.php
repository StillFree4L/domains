...
$result5 = mysql_query ("select * from totalmarks182 where studentID=$myrow[StudentID] and StudyGroupID=$ved");
$myrow5 = mysql_fetch_array($result5);

$mark1=$myrow5['exammark']; 
...
if ($mark2<0) 				{$mark2="Неявка по ув.п.";	$bukva2= ""; 	$ball2 = "";
	...
	echo "<td align=center class=border-ram>&nbsp; </td>";
		...
		echo "<td align=center class=border-ram> </td>";
			...
			if (($mark2 >=1) and   ($mark2 <=49))   	{$bukva2= "F"; 	$ball2 = "0";}
...
echo "<td align=center class=border-ram1> </td></tr>";
$i++;
}
