...
<table><tr><td><b><? echo "_____";?>	</td><td><b>семестр	</td><td><b>2018-2019</td><td><b>оқу жылы/уч.год</td></tr></table>
<table><tr><td>
<?
...
if ($t==1) 
{
$result6 = mysql_query ("select * from disved where ved=$ved and god=2018");
$myrow6 = mysql_fetch_array($result6);

$result5 = mysql_query ("select * from test_work where studentID=$myrow[StudentID] and testID=$myrow6[testID] and god=2018");
...
$result5 = mysql_query ("select * from oral_exam where studentID=$myrow[StudentID] and testID=$myrow6[id] and god=2018");
$myrow5 = mysql_fetch_array($result5);
//if (isset($myrow5['ball']) and ($myrow5['ball']>=0)) {
$mark1=$myrow5['ball']; 
//}
...
if (($mark>=50) and ($mark1>=50)) {
$res=mysql_query("UPDATE  `nitro`.`totalmarks172` SET  `exammark` =  '$mark1' ,`ap_exammark` =  '$mark1', ratings=$mark, ap_ratings=$mark, rating=$mark, ap_rating=$mark, totalmark=$mark2, ap_totalmark=$mark2 WHERE  `totalmarks172`.studygroupID=$ved and `totalmarks172`.studentID=$myrow[StudentID]");}
echo "</tr>";
$i++;
}
