	...
	public function actionIndex()
	{
        ...
        public function actionAdd()
        {
            ...
            if (isset($_POST['Instances'])) {
                ...
                $_POST['Instances']['type'] = 2;

                if (isset($_POST['Instances']['relations']))
                {

                    $model->parentCategories = $_POST['Instances']['relations'];                    
                    array_merge($model->parentCategories);

                    $model->attributes = $_POST['Instances'];
                    $model = EInstanceValidator::validateInstance($model);

                } else {
                    Yii::app()->user->setFlash('error', t('Укажите категорию'));
                    $model->attributes = $_POST['Instances'];
                }
