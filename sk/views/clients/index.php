    ...
    <section id="contact" class="section-bg wow fadeInUp">
        <div class="container">
            ...
            <?php if(\Yii::$app->user->can('admin')): ?>
                    <div class="text-center"><?= Html::a('Добавить клиента', ['create'], ['class' => 'btn btn-success']) ?></div><br>
            <?php endif; ?>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
                            <div class="portfolio-wrap" style="text-align: center">
                                <figure>
                                    ...
                                    <?= Html::img($img->getUrl(),['class'=>'img-fluid','alt'=>$model->client,'height'=>'100%', 'width'=>'100%']) ?>
                                    </a>
